## 3D Drawing tools to help with debugging.
## Just copied the text into a gd-script because I don't know a better way to get this into the project.
## Copied from: https://github.com/Ryan-Mirch/Line-and-Sphere-Drawing/blob/main/Draw3D.gd
## Original account: Ryan-Mirch
